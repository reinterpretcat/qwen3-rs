//! Integration tests for model exporter functionality
//!
//! These tests focus on the complete binary export process, including header validation,
//! binary format verification, and end-to-end export pipeline with mock data.

use qwen3_export::{BinaryModelExporter, ModelConfig};
